...
//
// Run: node test/no-keyword-routing.test.js
  ...
  try {
    ...
    check("guard flags a keyword classifier but allows the model router", () => {
      const r = guard.evaluateAddedLines([
        { file: "lib/x.js", line: 1, text: "const r = classifyIntent(message);" },
        { file: "lib/x.js", line: 2, text: "ouroRoute = await classifyIntentOuro(message);" },
      ]);
