...
- Agent **drift** over long horizons: **−42% success, 3.2× human interventions**, and drift-driven
  oversight *"can nullify intended automation cost savings"* ([2601.04170](https://arxiv.org/html/2601.04170)).
- RLHF *"systematically degrades calibration… a miscalibrated confidence signal becomes a root
  cause of cascading failures"* ([2602.06948](https://arxiv.org/pdf/2602.06948)).
...
| **M4/L3** Kreiss-inflated thresholds (#2789) | contraction→Lyapunov ([2404.11707](https://arxiv.org/html/2404.11707v1)); Fixed-Point Reasoners ([2606.18206](https://arxiv.org/abs/2606.18206)); attractor/equilibrium reasoners ([2605.21488](https://arxiv.org/pdf/2605.21488)); STARS | **Reason** | loop until latent fixed point = halting; Kreiss constant handles the **non-normal transient growth** plain contraction theory misses (our collapse-cert gap). |
