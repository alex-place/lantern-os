...
**Reads first:** [`TESSERACT-CSF-SINGULARITY.md`](../TESSERACT-CSF-SINGULARITY.md) (CSF ≡ Tesseract = one 3¹² lattice) · [`research/2026-06-19-convergence-tesseract-spiral.md`](2026-06-19-convergence-tesseract-spiral.md) (the flat 3-cube × ℝ depth axis this doc warps) · [`CSF-FORMAT-SPECIFICATION.md`](../CSF-FORMAT-SPECIFICATION.md) §2.7.1 (the real codec, CSF-Omni) · ``OURO-LOOPLM.md`` (the recurrent-depth engine).
