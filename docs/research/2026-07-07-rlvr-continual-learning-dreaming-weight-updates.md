...
- **[MEASURED — primary papers]** RL/RLVR is markedly more robust to catastrophic forgetting than SFT, and the mechanism is on-policy training's bias toward **KL-minimal solutions near the base policy** — forgetting is predicted by the KL divergence from the base measured on the new task, and explicit KL penalties are *not* required for the effect: [RL's Razor: Why Online Reinforcement Learning Forgets Less, arXiv:2509.04259](https://arxiv.org/abs/2509.04259) (the mechanism paper); [Reinforcement Fine-Tuning Naturally Mitigates Forgetting in Continual Post-Training, arXiv:2507.05386](https://arxiv.org/abs/2507.05386) (the continual post-training comparison); [Mechanistic origins of catastrophic forgetting: why RL preserves circuits better than SFT, arXiv:2605.28860](https://arxiv.org/abs/2605.28860) (circuit-level account). Secondary synthesis: [Wolfe (2026)](https://cameronrwolfe.substack.com/p/rl-continual-learning).
- **[MEASURED — honest counterpoint]** The robustness is **relative, not absolute**: [RL Forgets! Towards Continual Policy Optimization, arXiv:2607.04364](https://arxiv.org/abs/2607.04364) shows RL can still forget severely in continual settings and adds explicit drift control; divergence choice itself matters ([The Choice of Divergence, arXiv:2509.07430](https://arxiv.org/abs/2509.07430) — diversity collapse under the wrong divergence). The gate (leg 1 retention) stays load-bearing regardless.
