...
const SKIP_DIRS = ["apps/lantern-garage/desktop/dist/", "apps/lantern-garage/desktop/node_modules/"];
...
function repoPathToDst(p) {
  ...
  if (p.startsWith("apps/lantern-garage/")) return "resources/app/" + p.slice("apps/lantern-garage/".length);
