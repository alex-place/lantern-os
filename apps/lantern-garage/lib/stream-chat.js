...
async function handleStreamChat(req, url, res) {
  ...
  // Dream persona deleted (2026-06-26): chat NEVER routes through the Python
  // convergence/persona engine — it answers in a dream voice ("…carries a wish.
  // What are you protecting?") and reports provider:"unknown". All chat now goes
  // to the direct provider dispatch below with the technical ROUTER_PROMPT (cloud
  // coders lead; local is the offline backstop). Re-enable with CONVERGENCE_CHAT=1.
