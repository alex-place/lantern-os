    ...
    try {
      ...
      try {
        ...
        try {
          ...
          const vjPath = path.join(repoRoot, "public/version.json");
      ...
      if (codeChanged) {
        setTimeout(() => {
          try {
            ...
            const pm2Config = require("path").join(repoRoot, "ecosystem.config.js");
            try {
            ...
            try {
              execSync("node watchdog.js", { cwd: repoRoot, encoding: "utf8", timeout: 5000, stdio: "pipe" });
              process.exit(0);
            } catch {
