...
**Methodology:** Predictions are derived from v0.7 Python measurements + Rust zero-cost abstraction theory + symbolic-layer overhead models. All numbers are **pre-release estimates** to be validated by `cargo bench` in CI. If reality diverges by > 20%, the plan will
