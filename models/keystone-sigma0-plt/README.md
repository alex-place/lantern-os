...
> Remaining threads (faithful parity, eval vs a frontier coder, the Adaptive Loop Gate) are
> tracked in [ADAPTIVE-LOOP-GATE.md](ADAPTIVE-LOOP-GATE.md) and the GitHub issues.
