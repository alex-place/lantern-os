...
const SUBSYSTEMS = {
  ...
  // EXTENSION — optional capabilities beside the loop
  "news-collector":   { tier: "extension", module: "trading",   entry: "lib/news-collector.js",   flag: "TRADING_ENABLED" },
  "kalshi-collector": { tier: "extension", module: "trading",   entry: "lib/kalshi-collector.js", flag: "TRADING_ENABLED" },
  "brake-monitor":    { tier: "extension", module: "trading",   entry: "lib/brake-monitor.js",    flag: "BRAKE_MONITOR" },
  "crypto-collector": { tier: "extension", module: "trading",   entry: "lib/crypto-collector.js", flag: "KALSHI_CRYPTO_OBSERVER" },
  "job-worker":       { tier: "extension", module: "creator",   entry: "lib/job-worker.js",       flag: "CREATOR_ENABLED" },
  "cloudflare-tunnel":{ tier: "extension", module: "ops",       entry: "server.js",               flag: "LANTERN_CLOUDFLARE_TUNNEL" },
};
